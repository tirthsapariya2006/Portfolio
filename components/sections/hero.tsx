...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[92vh] flex items-center justify-center pt-28 sm:pt-32 pb-16 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-sky-500/10 text-sky-600 dark:text-sky-400 border border-sky-500/20"
            >
            ...
            >
              ...
              <p className="text-xl sm:text-2xl lg:text-[1.7rem] font-semibold text-zinc-700 dark:text-zinc-300 leading-snug">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto lg:mx-0 leading-relaxed"
            >
            ...
            <motion.div
              ...
              className="flex items-center justify-center lg:justify-start gap-2.5 pt-4 text-xs text-zinc-500 dark:text-zinc-400"
            >
